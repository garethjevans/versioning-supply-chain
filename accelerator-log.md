...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=garethjevans&repo=versioning-supply-chain",
  "buildTool" : "kpack",
  ...
  "hasSourceScan" : false,
  "hasTests" : false,
  "projectName" : "versioning-supply-chain",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [configWriterTemplate->config-writer-and-pu...(truncated), buildTool->kpack-template, source-test-scan-to-url->versioning-supply-ch...(truncated), externalDeliveryTemplate->deliverable-template, workloadType->version]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=garethjevans&repo=versioning-supply-chain'
...
┃ ┃ ┃ ┃ ┃ ┃  Info Combo running as Chain
┃ ┃ ┃ ┃ ┃ ┃ engine.transformations[0].validated.delegate.transformations[0].sources[1].delegate.transformations[3].delegate (Chain)
┃ ┃ ┃ ┃ ┃ ┃  Info Running Chain(Include, ReplaceText, ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.transformations[0].sources[1].delegate.transformations[3].delegate.transformations[0] (Include)
┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Will include [README.md, config/*.yaml]
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/values.yaml matched [README.md, config/*.yaml] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/cluster-supply-chain.yaml matched [README.md, config/*.yaml] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/schema.yaml matched [README.md, config/*.yaml] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┗ Debug README.md matched [README.md, config/*.yaml] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.transformations[0].sources[1].delegate.transformations[3].delegate.transformations[1] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace regex '# StartTests[\s\S]+?# EndTests' with ''
┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.transformations[0].sources[1].delegate.transformations[3].delegate.transformations[2] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace regex '# StartNoTests\s|# EndNoTests\s' with ''
...
┃ ┃ ┃ ┃ ┃ ┃  Info Combo running as Chain
┃ ┃ ┃ ┃ ┃ ┃ engine.transformations[0].validated.delegate.transformations[0].sources[1].delegate.transformations[8].delegate (Chain)
┃ ┃ ┃ ┃ ┃ ┃  Info Running Chain(Include, ReplaceText, ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.transformations[0].sources[1].delegate.transformations[8].delegate.transformations[0] (Include)
┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Will include [README.md, config/*.yaml]
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/values.yaml matched [README.md, config/*.yaml] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/cluster-supply-chain.yaml matched [README.md, config/*.yaml] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/schema.yaml matched [README.md, config/*.yaml] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┗ Debug README.md matched [README.md, config/*.yaml] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.transformations[0].sources[1].delegate.transformations[8].delegate.transformations[1] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace regex '# StartNoImageScan[\s\S]+?# EndNoImageScan\s' with ''
┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.transformations[0].sources[1].delegate.transformations[8].delegate.transformations[2] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace regex '# StartImageScan\s|# EndImageScan\s' with ''
